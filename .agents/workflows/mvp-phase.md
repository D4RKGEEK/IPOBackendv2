...
@~/.gemini/antigravity/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@~/.gemini/antigravity/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@~/.gemini/antigravity/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@~/.gemini/antigravity/gsd-core/references/spidr-splitting.md`. Briefly:
