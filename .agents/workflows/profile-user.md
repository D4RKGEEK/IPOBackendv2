...
Key references:
- @$HOME/.gemini/antigravity/gsd-core/references/ui-brand.md (display patterns)
- @$HOME/.gemini/antigravity/agents/gsd-user-profiler.md (profiler agent definition)
- @$HOME/.gemini/antigravity/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="$HOME/.gemini/antigravity/gsd-core/USER-PROFILE.md"
...
```bash
cp "$HOME/.gemini/antigravity/gsd-core/USER-PROFILE.md" "$HOME/.gemini/antigravity/USER-PROFILE.backup.md"
```
...
✓ Stores profile at $HOME/.gemini/antigravity/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `$HOME/.gemini/antigravity/gsd-core/references/user-profiling.md`
...
Reference: @$HOME/.gemini/antigravity/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to $HOME/.gemini/antigravity/gsd-core/USER-PROFILE.md"
...
**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at $HOME/.gemini/antigravity/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Your profile:    $HOME/.gemini/antigravity/gsd-core/USER-PROFILE.md
```
