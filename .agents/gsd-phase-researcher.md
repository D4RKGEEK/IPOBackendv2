...
@~/.gemini/antigravity/gsd-core/references/thinking-models-research.md
...
```bash
node "$HOME/.gemini/antigravity/gsd-core/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
