...
```bash
INIT=$(node "$HOME/.gemini/antigravity/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @~/.gemini/antigravity/gsd-core/templates/spec.md.
