...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@~/.gemini/antigravity/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `~/.gemini/antigravity/gsd-core/workflows/transition.md`.
...
- Follow @~/.gemini/antigravity/gsd-core/workflows/diagnose-issues.md
