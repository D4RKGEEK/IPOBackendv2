...
<reference>
@~/.gemini/antigravity/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `~/.gemini/antigravity/gsd-core/references/user-profiling.md` to load:
