...
<required_reading>
@~/.gemini/antigravity/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@~/.gemini/antigravity/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  ...
                  → checks ~/.gemini/antigravity/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = ~/.gemini/antigravity/gsd-core
                  → writes to ~/.gemini/antigravity/gsd-core/hooks/
...
@~/.gemini/antigravity/gsd-core/references/thinking-models-debug.md
...
- Read @~/.gemini/antigravity/gsd-core/references/common-bug-patterns.md
