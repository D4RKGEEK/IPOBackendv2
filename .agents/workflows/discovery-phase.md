...
See ~/.gemini/antigravity/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.gemini/antigravity/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.gemini/antigravity/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.gemini/antigravity/gsd-core/templates/discovery.md
...
Use ~/.gemini/antigravity/gsd-core/templates/discovery.md.
